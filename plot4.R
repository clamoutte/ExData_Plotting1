...
##set the optimal margins and allow 2 rows and 2 columns
...
legend("topright", cex=0.5, col=c("black","red","blue"), c("Sub_metering_1  ","Sub_metering_2  ", "Sub_metering_3  "),lty=c(1,1))
